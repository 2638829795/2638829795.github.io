...
if ($_GET['submit'] == 'yes') {
	...
	//通讯检测
	$array['与官方通讯'] = GetPostData('https://www.hadsky.com', '', 5) ? TRUE : FALSE;
	...
	$array['禁用magic_quotes_gpc函数'] = function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() ? '请关闭该函数' : TRUE;
